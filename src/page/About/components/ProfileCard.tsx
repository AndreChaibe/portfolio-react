...
import { ShinyText, CircularText } from "../../../ui/animations/index.jsx";
  ...
  return (
    ...
    <motion.div
      className={`${theme.background} rounded-b-3xl border-5 ${theme.colors.containerBorder}
                   max-[690px]:w-[70%] max-[575px]:w-[55%] max-[413px]:w-[50%]  max-[375px]:w-[45%]`}
    ...
    >
      ...
      <div className="flex justify-center items-center">
        <CircularText
          ...
          onHover="speedUp"
          spinDuration={20}>
          <img className="w-[10rem] m-auto rounded-[50%]" src={profilePhoto} alt="Foto do desenvolvedor web" />
        </CircularText>
      </div>
