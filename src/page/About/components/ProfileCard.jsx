...
const ProfileCard = () => {
  ...
  return (
    ...
    >
      ...
      <p className={`max-w-[40rem] pt-5 pr-10 pl-10 pb-10 font-general text-justify`}>Sou Desenvolvedor Front-end Júnior com mais de 1 ano de experiência prática criando interfaces eficientes e escaláveis utilizando HTML, CSS, JavaScript, além de trabalhar com bibliotecas e frameworks modernos como React e Tailwind CSS. Busco sempre unir performance, design e usabilidade em cada projeto.
        <br /><br />
