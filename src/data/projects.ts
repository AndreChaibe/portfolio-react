...
const projectsData: Project[] = [
    ...
    },
    {
        ...
        image: formularioImg,
        description: "Formulário de contato responsivo, focado em validar campos obrigatórios para garantir a integridade dos dados. Se algum campo não foi preenchido, o usuário recebe feedback imediato através de mensagens de erro e bordas em destaque vermelho.",
        technologies: ["HTML", "CSS", "JavaScript"],
