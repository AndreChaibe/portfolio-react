import { useThemes, themes, type Theme } from "../../context/Themes.js";
  ...
  return (
    ...
    >
      <SquareSplitHorizontal
        className={`${theme.background} w-17 h-17 ${theme.colors.icons} cursor-pointer bg-black/25 rounded-[50%] p-2.5 border-4 border-[#734892] max-[470px]:w-15 max-[470px]:h-15`}
      />
    </motion.button>
  );
};
