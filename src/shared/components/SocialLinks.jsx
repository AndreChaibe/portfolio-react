...
const SocialLinks = ({ bgIcons = "" }) => {

    return (
        <nav>
            <ul className='flex gap-7 transition-all duration-1000
                          [&>li]:hover:scale-[1.1] [&>li]:
                          [&>li>a>svg]:fill-current [&>li>a>svg]:rounded-[35%] [&>li>a>svg]:p-2.5 [&>li>a>svg]:text-[#a021c8]
                          max-[723px]:[&>li>a>svg]:w-[53px]
                          max-[723px]:[&>li>a>svg]:h-[53px]
                          max-[575px]:gap-4
                          max-[575px]:[&>li>a>svg]:w-[47px]
                          max-[575px]:[&>li>a>svg]:h-[47px]'>

                <motion.li
                    initial={{ opacity: 0, translateY: -50 }}
                    animate={{ opacity: 1, translateY: 0 }}
                    transition={{ duration: 0.7, delay: 2, type: "spring", mass: 0.6 }}>
                    <a href={curriculoPDF} download="Currículo-André-Chaibe.pdf">
                        <svg className={bgIcons} xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24">
                ...
                <motion.li
                    initial={{ opacity: 0, translateY: -50 }}
                    animate={{ opacity: 1, translateY: 0 }}
                    transition={{ duration: 0.7, delay: 2.5, type: "spring", mass: 0.6 }}>
                    <a href="https://www.linkedin.com/in/andre-chaibe/" target="_blank" rel="noopener">
                        <svg className={bgIcons} xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24">
                ...
                <motion.li
                    initial={{ opacity: 0, translateY: -50 }}
                    animate={{ opacity: 1, translateY: 0 }}
                    transition={{ duration: 0.7, delay: 3, type: "spring", mass: 0.6 }}>
                    <a href="https://github.com/AndreChaibe" target="_blank" rel="noopener">
                        <svg className={bgIcons} xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 16 16">
                ...
                <motion.li
                    initial={{ opacity: 0, translateY: -50 }}
                    animate={{ opacity: 1, translateY: 0 }}
                    transition={{ duration: 0.7, delay: 3.5, type: "spring", mass: 0.6 }}>
                    <a href="https://wa.me/5593992442462?text=Olá!%20Gostaria%20de%20discutir%20uma%20oportunidade%20profissional%20de%20desenvolvimento%20front-end%20com%20você" target="_blank" rel="noopener">
                        <svg className={bgIcons} xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 16 16">
                ...
                <motion.li
                    initial={{ opacity: 0, translateY: -50 }}
                    animate={{ opacity: 1, translateY: 0 }}
                    transition={{ duration: 0.7, delay: 4, type: "spring", mass: 0.6 }}>
                    <a href="mailto:andrechaibedev@gmail.com" target="_black" rel="noopener">
                        <svg className={bgIcons} xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24">
