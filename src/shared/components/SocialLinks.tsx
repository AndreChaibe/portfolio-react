...
const SocialLinks = ({ bgIcons = "" }: SocialLinksProps) => {
  return (
    <nav>
      <ul
        className="flex gap-7 transition-all duration-1000
                   [&>li]:hover:scale-[1.1]
      ...
      >
        ...
        >
          <a href="https://www.linkedin.com/in/andre-chaibe/" target="_blank" rel="noopener noreferrer">
            <svg
              className={bgIcons}
              xmlns="http://www.w3.org/2000/svg"
              width="60"
        ...
        >
          <a href="https://github.com/AndreChaibe" target="_blank" rel="noopener noreferrer">
            <svg
              className={bgIcons}
              xmlns="http://www.w3.org/2000/svg"
              width="60"
        ...
        >
          <a
            href="https://wa.me/5593992442462?text=Olá!%20Gostaria%20de%20discutir%20uma%20oportunidade%20profissional%20de%20desenvolvimento%20front-end%20com%20você"
            target="_blank"
        ...
        >
          <a href="mailto:andrechaibedev@gmail.com" target="_blank" rel="noopener noreferrer">
            <svg
              className={bgIcons}
              xmlns="http://www.w3.org/2000/svg"
              width="60"
